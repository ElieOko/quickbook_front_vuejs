...
//@ts-ignore
import { customerColumn } from '@/utils/constante/column/customer_col';
...
const itemChange =  (e:any)=> {
    const data =  customer.value.slice();
    const index = data.findIndex((d  => d.CustomerId === e.dataItem.id ))
